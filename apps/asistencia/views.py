...
class AsistenciaViewSet(GuaderiaMixin, viewsets.ModelViewSet):
    ...
    def hoy(self, request):
        ...
        registros = qs.order_by("id_nino__nombre")
        ...
        ninos_sin_registro = ninos_qs.exclude(id_nino__in=ninos_con_registro).values(
            "id_nino", "nombre"
        )
    ...
    def checkin(self, request):
        ...
        return Response(
            AsistenciaSerializer(asistencia).data, status=status.HTTP_201_CREATED
        )
